...
for(i in 1:length(samples)){
  qcRemovedReads_perSample[i] <- rawReads_perSample[grep(paste0("^",samples[i]), names(rawReads_perSample))]-sum(trimmed.reads[grep(paste0("^", samples[i]), names(trimmed.reads))])
}

refAssignedReads_perSample <- c() 
for(i in 1:length(samples)){
  refAssignedReads_perSample[i] <- fc.expr.stats[1,grep(paste0("^", samples.adj[i]), colnames(fc.expr.stats))]
}

refUnassigned_AmbiguityReads_perSample <- c() 
for(i in 1:length(samples)){
  refUnassigned_AmbiguityReads_perSample[i] <- fc.expr.stats[2,grep(paste0("^", samples.adj[i]), colnames(fc.expr.stats))]
}

refUnassigned_NoFeatureReads_perSample <- c() 
for(i in 1:length(samples)){
  refUnassigned_NoFeatureReads_perSample[i] <- fc.expr.stats[8,grep(paste0("^", samples.adj[i]), colnames(fc.expr.stats))]
}

refUnassigned_UnmappedReads_perSample <- c() 
for(i in 1:length(samples)){
  refUnassigned_UnmappedReads_perSample[i] <- fc.expr.stats[14,grep(paste0("^", samples.adj[i]), colnames(fc.expr.stats))]
}

mirbaseAssigned_species_MatureReads_perSample <- c()
for(i in 1:length(samples)){
  mirbaseAssigned_species_MatureReads_perSample[i] <- sum(star.mature_species[,grep(paste0("^", samples.adj[i]), colnames(star.mature_species))])
}

mirbaseAssigned_species_HairpinReads_perSample <- c()
for(i in 1:length(samples)){
  mirbaseAssigned_species_HairpinReads_perSample[i] <- sum(star.hairpin_species[,grep(paste0("^", samples.adj[i]), colnames(star.hairpin_species))])
}

contamination_trnaReads_perSample <- c()
for(i in 1:length(samples)){
  contamination_trnaReads_perSample[i] <- trna.mapped.reads[grep(paste0("^", samples.adj[i]), names(trna.mapped.reads))]
}

contamination_phixReads_perSample <- c()
for(i in 1:length(samples)){
  contamination_phixReads_perSample[i] <- phix.mapped.reads[grep(paste0("^", samples.adj[i]), names(phix.mapped.reads))]
}
...
for(i in 1:length(samples)){
  reference_CountsPerBiotype_perSample[,i] <- counts_per_biotype[-c(1:2),grep(paste0("^",samples[i],"_"), colnames(counts_per_biotype))]
}
