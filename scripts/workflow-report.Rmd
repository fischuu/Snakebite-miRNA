...
if(!is.element("snakemake",ls())){
  projFolder <- "/scratch/project_2001310/NanoBioFun_GLADIATOR/"
  pipelineFolder <- "/scratch/project_2001310/Pipeline-miRNA"
  pipelineConfig <- "/scratch/project_2001310/NanoBioFun_GLADIATOR/miRNA-pipeline_config-gladiator.yaml"
  serverConfig <- "/scratch/project_2001310/Pipeline-miRNA/miRNA-pipeline_puhti-config.yaml"
  refGenome.file <- "/scratch/project_2001310/NanoBioFun_GLADIATOR/References/GRCh38/Homo_sapiens.GRCh38.dna.primary_assembly.fa"
  refAnnot.file <- "/scratch/project_2001310/NanoBioFun_GLADIATOR/References/GRCh38/Homo_sapiens.GRCh38.95.gtf"
}
