...
barplot(plotThis, ylab="Concatenated files", las=2, names=labels, col=reportColours[3], yaxt="n")
...
```{r}
par(mar=c(15,5,2,0))
barplot(raw.reads, las=2, main="Raw, lane-wise reads", col=reportColours[1])
```
...
```{r}
par(mar=c(15,5,2,0))
barplot(trimmed.reads, las=2, main="Trimmed, lane-wise reads", col=reportColours[2])
```
...
barplot(rbind(raw.reads,trimmed.reads), beside=TRUE, las=2, main="Raw and Trimmed, lane-wise reads", col=c(reportColours[1], reportColours[2]))
...
```{r}
par(mar=c(15,6,2,0))
barplot(conc.reads, las=2, main="Concatenated reads", col=reportColours[3])
```
...
```{r}
par(mar=c(15,6,2,0))
barplot(raw.bases, las=2, main="Raw, lane-wise bases", col=reportColours[3])
```
```{r}
par(mar=c(15,6,2,0))
barplot(raw.bases/raw.reads, las=2, main="Raw, lane-wise bases per read", col=reportColours[3])
```
...
```{r}
par(mar=c(15,6,2,0))
barplot(trimmed.bases, las=2, main="Trimmed, lane-wise bases", col=reportColours[3])
```

```{r}
par(mar=c(15,6,2,0))
barplot(raw.bases-trimmed.bases, las=2, main="Number of trimmed bases per lane", col=reportColours[3])
```

```{r}
par(mar=c(15,6,2,0))
barplot(trimmed.bases/trimmed.reads, las=2, main="Trimmed, lane-wise bases per read", col=reportColours[3])
```
...
```{r}
par(mar=c(15,5,2,8), xpd=TRUE)
barplot(rbind(raw.bases,trimmed.bases), beside=TRUE, las=2, main="Raw and Trimmed, lane-wise bases", col=c(reportColours[1], reportColours[2]))
legend("topright", inset=c(-0.2,0), legend=c("Raw","Trimmed"), fill=c(reportColours[1], reportColours[2]))
```
...
barplot(plotThis, beside=TRUE, las=2, main="Avg read length in bases", col=c(reportColours[1], reportColours[2]))
legend("topright", inset=c(-0.2,0), legend=c("Raw","Trimmed"), fill=c(reportColours[1], reportColours[2]))
```
...
```{r}
par(mar=c(15,6,2,0))
barplot(conc.bases, las=2, main="Concatenated Bases", col=reportColours[3])
```
...
barplot(rbind(conc.reads,trna.unmapped.reads, trna.mapped.reads), beside=TRUE, las=2, main="Concatenated and tRNA reads", col=c(reportColours[1], reportColours[2], reportColours[3]))
...
```{r}
par(mar=c(15,6,2,8), xpd=TRUE)
barplot(rbind(conc.bases,trna.unmapped.bases, trna.mapped.bases), beside=TRUE, las=2, main="Concatenated and tRNA bases", col=c(reportColours[1], reportColours[2], reportColours[3]))
legend("topright", inset=c(-0.2,0), legend=c("Conc.","tRNA (unmapped)", "tRNA (mapped)"), fill=c(reportColours[1], reportColours[2], reportColours[3]))
```
...
```{r}
par(mar=c(15,6,2,8), xpd=TRUE)
barplot(rbind(trna.unmapped.reads,phix.unmapped.reads, phix.mapped.reads), beside=TRUE, las=2, main="tRNA filtered and PhiX reads", col=c(reportColours[1], reportColours[2], reportColours[3]))
...
```{r}
par(mar=c(15,6,2,8), xpd=TRUE)
barplot(rbind(trna.unmapped.bases,phix.unmapped.bases, phix.mapped.bases), beside=TRUE, las=2, main="tRNA filtered and PhiX bases", col=c(reportColours[1], reportColours[2], reportColours[3]))
...
barplot(rbind(phix.unmapped.reads,mature.unmapped.reads, mature.mapped.reads), beside=TRUE, las=2, main="Filtered reads 
        aligned to Mature.fa", col=c(reportColours[1], reportColours[2], reportColours[3]))
...
```{r}
par(mar=c(15,6,2,8), xpd=TRUE)
barplot(rbind(phix.unmapped.bases, mature.unmapped.bases, mature.mapped.bases), beside=TRUE, las=2, main="Filtered bases aligned to Mature.fa", col=c(reportColours[1], reportColours[2], reportColours[3]))
legend("topright", inset=c(-0.2,0), legend=c("Total reads","Mature.fa (unmapped)", "Mature.fa (mapped)"), fill=c(reportColours[1], reportColours[2], reportColours[3]))
```
...
barplot(rbind(phix.unmapped.reads,mature_species.unmapped.reads, mature_species.mapped.reads), beside=TRUE, las=2, main="Filtered reads 
        aligned to Mature_Species.fa", col=c(reportColours[1], reportColours[2], reportColours[3]))
...
```{r}
par(mar=c(15,6,2,8), xpd=TRUE)
barplot(rbind(phix.unmapped.bases, mature_species.unmapped.bases, mature_species.mapped.bases), beside=TRUE, las=2, main="Filtered bases aligned to Mature_Species.fa", col=c(reportColours[1], reportColours[2], reportColours[3]))
legend("topright", inset=c(-0.2,0), legend=c("Total reads","Mature_Species.fa (unmapped)", "Mature_Species.fa (mapped)"), fill=c(reportColours[1], reportColours[2], reportColours[3]))
```
...
```{r}
par(mar=c(15,6,2,8), xpd=TRUE)
barplot(mature.mapped.reads - mature_species.mapped.reads, las=2, main="Reads that align more to Mature.fa vs Mature_Species.fa", col=c(reportColours[3]))
```
...
```{r}
par(mar=c(15,6,2,8), xpd=TRUE)
barplot(rbind(mature.unmapped.reads, hairpin.unmapped.reads, hairpin.mapped.reads), beside=TRUE, las=2, main="Mature.fa unaligned reads aligned to Hairpin.fa", col=c(reportColours[1], reportColours[2], reportColours[3]))
...
```{r}
par(mar=c(15,6,2,8), xpd=TRUE)
barplot(rbind(mature.unmapped.bases, hairpin.unmapped.bases, hairpin.mapped.bases), beside=TRUE, las=2, main="Mature.fa unaligned bases aligned to Hairpin.fa", col=c(reportColours[1], reportColours[2], reportColours[3]))
legend("topright", inset=c(-0.2,0), legend=c("Mature.fa (unmapped)","Hairpin.fa (unmapped)", "Hairpin.fa (mapped)"), fill=c(reportColours[1], reportColours[2], reportColours[3]))
```
...
par(mar=c(15,6,2,8), xpd=TRUE)
barplot(rbind(hairpin.unmapped.reads, reference.bowtie.unmapped.reads, reference.bowtie.mapped.reads), beside=TRUE, las=2, main=useTitle, col=c(reportColours[1], reportColours[2], reportColours[3]))
...
par(mar=c(15,6,2,8), xpd=TRUE)
barplot(rbind(hairpin.unmapped.bases, reference.bowtie.unmapped.bases, reference.bowtie.mapped.bases), beside=TRUE, las=2, main=useTitle, col=c(reportColours[1], reportColours[2], reportColours[3]))
legend("topright", inset=c(-0.2,0), legend=c("Hairpin.fa (unmapped)","Reference (unmapped)", "Reference (mapped)"), fill=c(reportColours[1], reportColours[2], reportColours[3]))
```
...
```{r}
barplot(starlogs.totalReads - apply(starlogs.matrix,2,sum), las=2, main="Unconsidered reads in above barplot", col=reportColours[1])
```
...
```{r}
barplot(apply(star.mature[,-1],2,sum), las=2, main="Reads aligned to Mature.fa", col=reportColours[1])
```
...
```{r}
barplot(apply(star.hairpin[,-1],2,sum), las=2, main="Reads aligned to Hairpin.fa", col=reportColours[1])
```
...
```{r}
barplot(apply(star.hairpin_species[,-1], 2, sum), las=2, main="Reads aligned to Hairpin_Species.fa", col=reportColours[1])
```
```{r}
# Get the quantification
